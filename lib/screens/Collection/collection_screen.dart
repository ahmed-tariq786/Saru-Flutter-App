...
class CollectionScreen extends StatefulWidget {
  const CollectionScreen({super.key, required this.id, required this.title});
...
class _CollectionScreenState extends State<CollectionScreen> {
  ...
  void _loadData() async {
    ...
    final result = await collectionController.fetchProductsByCollectionId(widget.id);
              ...
              children: [
                ...
                TweenAnimationBuilder<double>(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildProductsHeader(products, filters, widget.id),
                      _buildAppliedFiltersChips(widget.id, filters),
